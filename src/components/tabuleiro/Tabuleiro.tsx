...
const Tabuleiro: React.FC<IHeroProps> = ({ buttonLeft, buttonRight, buttonDown, buttonUp }) => {
  ...
  return (
    <TabuleiroContainer>
      ...
      <Trap key="trap24" initialPosition={isSmallScreen ? { y: 15, x: 18 } : { y: 5.1, x: 12.4 }} text={0} />
      <Trap key="trap24" initialPosition={isSmallScreen ? { y: 15, x: 18 } : { y: 6.1, x: 11.4 }} text={0} />
      <Trap key="trap24" initialPosition={isSmallScreen ? { y: 15, x: 18 } : { y: 8.1, x: 17.6 }} text={0} />

      <Trap key="trap16" initialPosition={isSmallScreen ? { y: 7, x: 8 } : { y: 4.1, x: 14.5 }} text={0} />
      ...
      <Trap key="trap24" initialPosition={isSmallScreen ? { y: 15, x: 18 } : { y: 10.1, x: 10.4 }} text={0} />

      <Trap key="trap25" initialPosition={isSmallScreen ? { y: 15, x: 17 } : { y: 10.1, x: 14.5 }} text={0} />
      <Trap key="trap26" initialPosition={isSmallScreen ? { y: 15, x: 16 } : { y: 11.1, x: 15.5 }} text={0} />

      <Trap key="trap27" initialPosition={isSmallScreen ? { y: 16, x: 15 } : { y: 12.1, x: 10.4 }} text={0} />
      <Trap key="trap28" initialPosition={isSmallScreen ? { y: 17, x: 14 } :  { y: 13.1, x: 9.4 }} text={0} />

      <Trap key="trap17" initialPosition={isSmallScreen ? { y: 14, x: 4 } : { y: 15.1, x: 11.4 }} text={0} />
      <Trap key="trap18" initialPosition={isSmallScreen ? { y: 15, x: 5 } : { y: 16.1, x: 12.4 }} text={0} />
      <Trap key="trap19" initialPosition={isSmallScreen ? { y: 17, x: 6 } : { y: 17.1, x: 13.4 }} text={0} />

      <Trap key="trap14" initialPosition={isSmallScreen ? { y: 10, x: 9 } : { y: 13.1, x: 17.6 }} text={0} />
